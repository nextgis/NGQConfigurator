...
class ConnectionSettingsDialog(QDialog, Ui_Dialog):
    def __init__(self, parent=None):
        ...
        #    settings.value("jenkins_user_pass", "", type = unicode))
        # self.leJobName.setText(
        #    settings.value("jenkins_job_name", "", type = unicode))
        self.adjustSize()
...
class BuildsManagerMain(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        #     self.connectionSettingsDialogAction)
...
class BuildsManagerApp(QApplication):
    def __init__(self, args):
        ...
        self.buid_system_path = u"http://176.9.38.120/jenkins"
        ...
        log_file_name = "_".join(
                    unicode(self.applicationName()).split(u" "))+"_log.txt"
